...
@REM LINK FILES
link build\bmp.obj build\gfx.obj build\wnd.obj build\main.obj libs\SDL2.lib kernel32.lib msvcrt.lib legacy_stdio_definitions.lib /subsystem:console /entry:entry /out:dist\isogame.exe
@REM COPY FILES
